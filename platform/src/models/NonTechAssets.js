...
const NonTechAssetSchema = new mongoose.Schema({
...
const NonTechAssets = mongoose.models.NonTechAssets || mongoose.model("NonTechAssets", NonTechAssetSchema);

export default NonTechAssets;