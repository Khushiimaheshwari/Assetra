      ...
      {addingIssue && (
        <div style={styles.modalOverlay} onClick={() => setAddingIssue(null)}>
          <div style={styles.issueModal} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ ...styles.issueDetailRow, backgroundColor: C.ice, borderRadius: '8px', padding: '10px 14px', marginBottom: '12px' }}>
              <div style={styles.issueDetailLabel}>Asset</div>
              <div style={styles.issueDetailValue}>{addingIssue.Asset_Name}</div>
            </div>

            <div style={{ ...styles.issueDetailRow, backgroundColor: C.ice, borderRadius: '8px', padding: '10px 14px', marginBottom: '16px' }}>
